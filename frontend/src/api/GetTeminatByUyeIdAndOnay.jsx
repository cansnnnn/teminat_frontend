...
async function GetTeminatByUyeIdAndOnayFromBackend (uyeID) {

    let teminatModelArray = [];

        try{
            const response = await fetch(`http://localhost:8080/teminat_teminatlar_3/uyeIdOnayTeminatlar?uyeId=${uyeID}`, {method:"GET"});
...
export default GetTeminatByUyeIdAndOnayFromBackend;