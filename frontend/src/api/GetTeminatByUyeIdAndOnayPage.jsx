...
async function GetTeminatByUyeIdAndOnayPageFromBackend (uyeID) {

    let teminatModelArray = [];

        try{
            const response = await fetch(`http://localhost:8080/teminat_teminatlar_3/uyeIdOnayTeminatlarPage?uyeId=${uyeID}`, {method:"GET"});
...
export default GetTeminatByUyeIdAndOnayPageFromBackend;